...
export class UserServices {
    ...
    static async registerUser(message: Message): Promise<MomentoUser> {
        ...
        let newMomentoUser: MomentoUser = new MomentoUser(
            ...
            "",
            0,
            "https://discord.com/channels/1084823963974246414/1210763625250291772/1210778080940138528",
            "https://discord.com/channels/1084823963974246414/1210763625250291772/1210778701990727710",
            [
